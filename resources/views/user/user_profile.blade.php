            ...
            <div class="col-xl-4">
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <input type="hidden" name="_token" value="" class="__token">
                        <input type="hidden" name="" value="" class="label_avatar">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputPhone" type="text"
                                        placeholder="Số điện thoại" value="{{ $user[0]->phoneNumber }}" required>
                                </div>
                            </div>
